...
const cacheName = 'LAWk7AbbyKleespie-2021-03-22 21:50:18.612951'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWk7AbbyKleespie'.length) === 'LAWk7AbbyKleespie') {
